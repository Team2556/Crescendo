...
public class ChaseTagCommand extends Command {
  ...
  public ChaseTagCommand(
    ...
    estimator = new PhotonPoseEstimator(Constants.FieldK.kFieldLayout, PoseStrategy.LOWEST_AMBIGUITY, photonCamera,
        ROBOT_TO_CAMERA);
  ...
  public void execute() {
    ...
    // swerveSubsystem.addVisionMeasurement(est.estimatedPose.toPose2d(),
    ...
    if (photonRes.hasTargets()) {
      ...
      // lastTarget = target;
      // SmartDashboard.putString("Tag Pose",
      // target.getBestCameraToTarget().toString());
